...
public class MlgMode : MonoBehaviour {
	...
	bool screenOverlayEnabled = false;
	bool timerOn = false;
	bool bass = false;
	float timer = 1f;

	int currentColor = 0;
	Color[] colors = new Color[] {new Color(0,1,0,0.2f),new Color(1,0,0,0.2f),new Color(0,0,1,0.2f),new Color(1,1,0,0.2f)};
	float colorTimer = 0.25f;
